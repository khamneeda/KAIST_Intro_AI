    ...
    private void ReceiveData()
    {
        while (true)
        {
            try
            {
                ...
                // Text format: abcde, each for lf rf mid lb rb
                lf = int.Parse(text[0].ToString());
                rf = int.Parse(text[1].ToString());
                mid = int.Parse(text[2].ToString());
                lb = int.Parse(text[3].ToString());
                rb = int.Parse(text[4].ToString());
